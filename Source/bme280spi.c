...
#ifdef TFT3IN5
#ifndef HAL_LCD_CS3_PORT
#define HAL_LCD_CS3_PORT 0
#endif
#ifndef HAL_LCD_CS3_PIN
#define HAL_LCD_CS3_PIN  1
#endif
#endif
...
#ifdef TFT3IN5
#define LCD_SPI_BEGIN3()    HAL_IO_SET(HAL_LCD_CS3_PORT,  HAL_LCD_CS3_PIN,  0); /* chip select 2*/
#endif
#define LCD_SPI_END()                                                         \
{                                                                             \
  asm("NOP");                                                                 \
...
#ifdef TFT3IN5
  HAL_CONFIG_IO_INPUT(HAL_LCD_CS3_PORT,   HAL_LCD_CS3_PIN,   0);
#endif
}
...
void HalLcd_HW_Write_AllData(uint16 data, uint32 datalen)
{
  LCD_SPI_BEGIN2();
  LCD_DO_WRITE();
  uint32 i;
