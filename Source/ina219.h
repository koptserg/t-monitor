...
#define INA219_ADDR_READ  (0x40 << 1) | 0x01
#define INA219_ADDR_WRITE (0x40 << 1) | 0x00
...
extern void ina219_setCalibration_32V_2A(void);
extern void ina219_setCalibration_32V_1A(void);
extern void ina219_setCalibration_16V_400mA(void);
extern float ina219_getBusVoltage_V(void);
extern float ina219_getShuntVoltage_mV(void);
extern float ina219_getCurrent_mA(void);
extern float ina219_getPower_mW(void);
extern void powerSave(bool on);
